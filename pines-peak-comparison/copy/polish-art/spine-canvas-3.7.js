...
(function (spine) {
	var AssetManager = (function () {
		...
		AssetManager.downloadText = function (url, success, error) {
			var request = new XMLHttp_DISABLED();
	...
	var SharedAssetManager = (function () {
		...
		SharedAssetManager.prototype.loadText = function (clientId, path) {
			...
			request.onreadystatechange = function () {
				if (request.readyState == XMLHttp_DISABLED.DONE) {
...
//# sourceMappingURL=spine-canvas.js.mapif (typeof window !== 'undefined') window.spine = spine;
